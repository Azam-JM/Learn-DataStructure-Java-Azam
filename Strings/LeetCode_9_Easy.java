class Solution {
    ...
    public boolean isPalindrome(int x) {
        String s = Integer.toString(x); // Convert the integer to a string
        ...
        boolean palindrome = true; // Initialize a boolean variable to store whether the number is a palindrome or not
        
        // Iterate over the string using two pointers
        while(ptr1 < ptr2){
            // If characters at both pointers are not equal, the number is not a palindrome
        ...
        return palindrome; // Return whether the number is a palindrome or not
    }
}
